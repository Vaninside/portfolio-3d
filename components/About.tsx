            ...
            <div className="grid sm:grid-cols-2 gap-4 pt-4 border-t border-border">
              {skills.map((skill) => (
                ...
                >
                  ...
                  <div>
                    <h4 className="font-semibold text-foreground">{aboutSkills[skill.key].label}</h4>
                    <p className="text-sm text-muted-foreground mt-0.5">{aboutSkills[skill.key].desc}</p>
                  </div>
                </motion.div>
              ))}
            </div>
