...
- **Dead sections dropped:** `language.*`, `footer.copyright`, `footer.builtWith`, and per-section extras (`projects.featured`, `projects.period`, `projects.technologies`, `projects.points`, `education.degree`, `education.university`, `education.gpa`, `education.thesis`, `education.graduation`, `contact.linkedin`, `contact.github`, `organization.role`, `organization.period`) are present in `en.json` but never read by any component. They are not transcribed. This is intentional, not an omission.
